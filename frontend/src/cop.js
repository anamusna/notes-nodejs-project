...
import "./index.css";
import { addUrl, listUrl, deleteUrl } from './api/apiConfig';
    ...
    return (
      <div className="app">
        ...
        >
          ...
          <input type="text" name="title" placeholder="title" onChange={this.getPostValues} />
          <label htmlFor="body" className="labels">

          </label>
          <input type="text" name="body" onChange={this.getPostValues} placeholder="body" />
